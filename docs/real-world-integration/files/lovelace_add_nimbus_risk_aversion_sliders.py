...
SLIDER_CARDS = [
    {
        ...
        "entity": "number.nimbus_solver_import_price_risk_aversion",
        "name": "Import Price Risk Aversion",
    ...
    {
        "type": "custom:mushroom-number-card",
        "entity": "number.nimbus_solver_export_price_risk_aversion",
        "name": "Export Price Risk Aversion",
        "secondary_info": "state",
        "icon": "mdi:speedometer",
        "layout": "vertical",
        "display_mode": "slider",
    ...
    {
        "type": "custom:mushroom-number-card",
        "entity": "number.nimbus_solver_risk_aversion",
        "name": "Risk Aversion",
        "secondary_info": "state",
        "icon": "mdi:speedometer",
        "layout": "vertical",
