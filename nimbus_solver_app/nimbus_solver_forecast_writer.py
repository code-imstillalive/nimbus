...
def main() -> None:
    ...
    #
    # Uses plan.battery_charge_kw/plan.battery_discharge_kw directly (this
    # file's own convention -- no separate corrected_battery_charge_kw/
    # corrected_battery_discharge_kw pair exists here, only net_battery
    # and corrected_grid_import get the fixed-export violation clamp
    # above) and this file's own already-computed _round_trip_eff.
    flow_decomp = [
        _flow_decomposition(
            solar_kw[i],
            load_kw[i],
    ...
    flow_econ = _compute_flow_economics(
        ...
        export_price,
        period_hours_arr,
        round_trip_efficiency=_round_trip_eff,
        initial_soc_kwh=initial_soc_kwh,
    )
