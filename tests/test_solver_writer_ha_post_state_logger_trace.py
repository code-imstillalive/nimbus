...
if __name__ == "__main__":
    test_module_defines_a_real_stdlib_logger()
    test_ha_post_state_mirrors_the_85_trace_to_the_logger_not_just_print()
    test_raw_states_async_set_fallback_has_its_own_logger_trace()
    print("OK")
