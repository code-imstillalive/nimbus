...
A Home Assistant custom_component (`custom_components/nimbus_load`) that forecasts
...
Long-term direction: grow into the household's own load/power optimizer, replacing
HAEO's role entirely — not just complementing it.
