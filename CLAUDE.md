...
## ⚠️ CURRENT STATE (2026-09-04) — read this first

**Version: v0.94.86** (up from v0.94.81 at the start of today). Four real releases shipped today working through Mark Purcell's codebase-review parent issue (#336): #355, #357, #368 all closed; #360 (test infrastructure, 7 separate findings) is a partial fix in progress, not yet shipped as of this writing.
